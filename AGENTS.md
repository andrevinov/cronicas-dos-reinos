...
- **Task 46:** 40–45 ficam na mesma dupla; com âncora, `cronica preparar ... --oportunidade-sidequest --sidequest-origem-tipo ... --sidequest-ancora-tipo ... --sidequest-ancora ...` e enviar no mesmo `cronica concluir`; só materializar se a oferta foi narrada. `--sem-oportunidade-sidequest` = zero Task40–45. Task32/33 = legado frio, nunca origem/hot path.
