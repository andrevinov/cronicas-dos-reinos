...
**Iniciativa do elenco:** `--participante <id>` é memória/presença de cena; só o subconjunto realmente presente/contactável indicado por `--interlocutor <id>` repetível recebe decisão NV-16. Participante não vira interlocutor sozinho; interlocutor não cria presença, encontro ou side quest. No máximo uma abertura por janela; silêncio/adiamento/inelegibilidade ficam explícitos.
