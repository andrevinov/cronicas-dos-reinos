#!/usr/bin/env python3
"""Porta de cena com presença, quests, torneio, condições e incidentes sérios."""
...
import torneio_clandestino_cena as _tournament

# Task31 mantém o procedural de sidequest morto. Presença e quests canônicas vêm
# primeiro; Task37 só consulta convite em encontro explícito com Luath. Task34
# projeta condições e Task35 permanece a última camada espacial/incidental.
