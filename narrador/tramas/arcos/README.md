...
orquestracao:
  fontes:
    ...
    marcos_antagonistas:
      arquivo: narrador/elenco/juppongatana/marcos-de-aparicao.md
  plano_mestre:
...
índice `narrador/elenco/agentes/index.yaml`; aliados pelo índice de entradas; direções
...
autorizado abre `narrador/elenco/agentes/index.yaml` + **um único fragmento de agente**
...
`narrador/elenco/juppongatana/marcos-de-aparicao.md`. O índice compacto guarda somente
...
janela ou gatilhos. Esses dados continuam em `narrador/elenco/entradas/`. A Fase 9 usa
