...
Ela **não substitui** `narrador/elenco/masao/`, `narrador/elenco/juppongatana/`, relógios, relações, sessões ou qualquer outra fonte canônica. Os fragmentos daqui apenas condensam o estado de agência necessário para responder rapidamente: objetivo, recursos, restrições, presença, mobilidade, atuação local, conhecimento e plano corrente.
