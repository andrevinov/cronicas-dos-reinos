...
Depois disso, o conhecimento incremental e `narrador/mundo/rastros/index.yaml` entram no **mesmo plano de staging/journal**. Só então a instalação começa. Se houver queda no meio, o mecanismo de recuperação já existente instala ou repara exatamente o mesmo lote.
