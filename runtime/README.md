...
2. se faltar estado operacional, leia `runtime/contexto.yaml`;
3. se a decisão depender da situação imediata, leia `runtime/cena.yaml`;
4. só depois siga os ponteiros para entidade, regra, relação, histórico ou fonte profunda.
