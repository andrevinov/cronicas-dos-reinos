...
Estilo: `narracao/principios/guia-de-narrativa.md`. Limites: `narracao/principios/limites.md`. Entrada: `docs/agente/fundamentos/protocolo-de-entrada.md`. Acesso: `docs/agente/operacao/acesso-e-operacoes.md`. Consolidação: `docs/agente/operacao/consolidacao-transacional.md`. Memória: `docs/agente/memoria/memoria-de-sessoes.md`.
...
Contrato completo: `docs/agente/fundamentos/protocolo-de-entrada.md`.
...
```text
narrador/historico/sessoes/NNN/rolagens-ocultas.md
```
...
Material reservado necessário fica em `narrador/historico/sessoes/NNN/`; não carregar a pasta inteira sem lacuna concreta.
...
Relógios reservados usam `relogio:<id>` e permanecem em `narrador/mundo/relogios/`. Delta com `visibilidade: narrador` não pode ser instalado em domínio público.
