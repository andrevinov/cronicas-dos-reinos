...
Limites de conteúdo adulto, romance, intimidade e violência ficam definidos em `narracao/principios/limites.md`.
...
Detalhes operacionais: `docs/agente/narrativa/densidade-narrativa.md`.
...
Aplicar sempre os limites de `narracao/principios/limites.md`.
