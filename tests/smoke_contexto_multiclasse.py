...
with tempfile.TemporaryDirectory() as tmp:
    ...
    write(repo, "narrador/tramas/arcos/index.yaml", {
    ...
    write(repo, "narrador/tramas/arcos/parte_1.yaml", {
        ...
        "orquestracao": {"fontes": {"plano": {"tipo": "documento_reservado", "arquivo": "narrador/elenco/masao/plano.md"}}, "plano_mestre": {"agente": "masao_hirasawa", "objetivo": "objetivo", "referencia": "plano"}},
    ...
    write(repo, "narrador/tramas/arcos/marcos-aparicao.yaml", {
    ...
    write(repo, "narrador/tramas/arcos/estado-marcos-aparicao.yaml", {
    ...
    write(repo, "narrador/elenco/agentes/index.yaml", {
    ...
    write(repo, "narrador/tramas/direcoes/estado.yaml", {
    ...
    assert all("narrador/elenco/agentes/kajiwara_shizune.yaml" not in source for source in result["fontes_lidas"])
