...
**Proposta para revisão.** Nenhuma task deste diretório está implementada.
...
| --- | --- | --- |
| [RM-01](rm01-catalogo-hierarquico-e-corte-da-serie.md) | catálogo hierárquico, guardrails e política de série | nenhuma |
