# Acionamentos causais dos agentes leves
...
perfil estático, relação e medidor inteiros. A projeção usa a seleção de memória
relevante e de cena,
...
nativos ou qualidade da narração sem episódios comparáveis do benchmark narrativo.

## Validação e instalação

Os cenários de regressão são temporários: promessa durável, prazo curto, fontes
