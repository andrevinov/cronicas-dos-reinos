...
O baralho local e o escopo de trânsito compartilham `narrador/mundo/microeventos-locais/estado.yaml`. Confirmar um deles muda o fingerprint do arquivo usado pelo outro.
