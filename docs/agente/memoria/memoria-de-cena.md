# Memória na preparação e na retomada
...
Contatos autorizados acrescentam a memória do interlocutor físico ao
...
Contrato relacionado: `docs/agente/mundo/compromissos-estruturados.md`.
...
writers e da captura de memória durável. O mesmo buffer, histórico e checkpoint mantêm a única
...
existente. Contrato e exemplos: `docs/agente/narrativa/personalidade-decisoria.md`.
...
Quando um campo indispensável faltar, usa a consulta de memória relevante indicada, sem busca
...
Testes isolados cobrem o preparo, o registro durável, pendências antes do checkpoint,
