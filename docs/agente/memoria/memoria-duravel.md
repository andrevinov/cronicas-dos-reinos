# Acontecimentos como memória durável
...
A integração automática da memória na preparação e retomada pertence à memória
de cena, não a este contrato de persistência.
...
continuam nos seus domínios próprios. A memória durável não transforma rumor em verdade,
...
continuam distintas. Os nomes dos campos são reconhecidos pela projeção de memória relevante.
