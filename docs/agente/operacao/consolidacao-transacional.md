...
Rolagens ocultas armazenadas na transação são consolidadas em `narrador/historico/sessoes/NNN/rolagens-ocultas.md` em lote.

Relógios reservados usam `relogio:<id>` e ficam sob `narrador/mundo/relogios/`.
