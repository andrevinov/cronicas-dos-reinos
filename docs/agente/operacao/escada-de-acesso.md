...
**Pare de buscar quando o contexto bastar; não confunda isso com parar de narrar.** Densidade literária é regulada por `docs/agente/narrativa/densidade-narrativa.md`, não pelo teto de bytes das ferramentas.
