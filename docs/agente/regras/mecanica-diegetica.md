...
O contrato atual protege novas gravações. Ele não reescreve automaticamente
transcrições antigas, porque isso alteraria um artefato histórico para resolver
uma convenção introduzida depois.
