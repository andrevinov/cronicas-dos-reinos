...
execução de planos, contatos ou prazos dos domínios causais correspondentes.
...
normal; acontecimentos marcantes continuam usando o contrato de memória durável.
...
compartilhado pela seleção de memória relevante e pela memória de cena. Nenhuma leitura adicional
...
Recibos da memória de cena abrangem o perfil selecionado; fonte alterada invalida seu item,
...
orçamento, consulta dirigida, captura de memória durável e retomada em subprocesso YAML/JSON.
