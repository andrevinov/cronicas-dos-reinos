...
Esta política define como a suíte deve evoluir e como preservar evidências
históricas sem acoplar testes ao estado vivo.
...
Perfis e comandos: `docs/agente/engenharia/perfis-de-testes.md`.
