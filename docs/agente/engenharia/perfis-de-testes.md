...
No GitHub Actions, conforme a política vigente, a suíte completa é executada uma
única vez por `Integridade`; o workflow de Preflight roda seus demais gates com
`--sem-testes`.
